...
export default function App() {
  ...
  return (
    <>
    <Modal isOpen={true} onClose={() => {}} className="max-w-[700px] m-4 max-h-[90vh]">
      <div
        className="flex justify-center items-start pdf-edit-mode  overflow-y-auto max-h-[90vh]"
        id="print-area"
        ref={contentRef}
      >
        <div className={clsx("print-page w-[210mm] print:h-[297mm] mx-auto bg-white shadow-2xl print:shadow-none print:overflow-hidden")}>
              ...
              <div className="pl-4 space-y-6 p-4 rounded-lg print:bg-transparent print:border-0 print:p-2">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-0">
                    ...
                    <div className="border-b-2 border-gray-300 pb-1.5 label">
                      <p className="text-sm text-black">
                        {dayjs(watch("arriveTime")).format("MM.DD.YYYY HH:mm")}
                      </p>
                    </div>
                    <DatePicker
                      id="arriveTime"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-0">
                    ...
                    <div className="border-b-2 border-gray-300 pb-1.5 label">
                      <p className="text-sm text-black">
                        {dayjs(watch("finishTime")).format("MM.DD.YYYY HH:mm")}
                      </p>
                    </div>
